...
.PHONY: ci-lint-install-dependencies
ci-lint-install-dependencies: ## Install helm chart dependencies
...
lint-charts: ## Lint Helm charts
	make ci-add-helm-repos
	make ci-lint-install-dependencies
	make ci-lint-helm-charts
